...
COPY kibana-oss-7.4.2-linux-x86_64.tar.gz /opt
...
RUN kibana-plugin install "https://d3g5vo6xdbdb9a.cloudfront.net/downloads/kibana-plugins/opendistro-sql-kibana/sql-kibana-1.4.0.0.zip" && \
