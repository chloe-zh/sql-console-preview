...
COPY opendistro-query-workbench-1.10.1.1.zip /usr/share/plugins/opendistro-query-workbench-1.10.1.1.zip
...
RUN kibana-plugin install file:///usr/share/plugins/trace_analytics-0.0.1.zip --allow-root && \ 
    ...
    kibana-plugin install file:///usr/share/plugins/opendistro-query-workbench-1.10.1.1.zip --allow-root && \
